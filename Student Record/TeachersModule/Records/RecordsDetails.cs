...
{
    public partial class RecordsDetails : Form
    {
        ...
        public RecordsDetails(string? id, string? faculty_id, string? rank)
        {
            InitializeComponent();
            this.id = id;
            ...
            if (db != null)
            {
                ...
                if (docSnap.Exists)
                {
                        ...
                        && student.grade_level != null)
                    {
                        ...
                        lrn_lbl.Text = "LRN: " + _lrn;
                        grade_section_lbl.Text = "Grade/Section: " + _grade_lvl + "-" + _section;
                        gender_lbl.Text = "Gender: " + _gender;
                        bday_lbl.Text = "Date of Birth: " + _dob.ToString("MMMM dd, yyyy");
                        address_lbl.Text = "Address: " + _address;
                        contact_num_lbl.Text = "Contact #: " + _contact_number;
                        strand_lbl.Text = "Strand: " + _strand;
                        father_lbl.Text = "Father's Name: " + _father;
                        father_contact_lbl.Text = "Contact #: " + _father_contact;
                        mother_lbl.Text = "Mother's Name: " + _mother;
                        mother_contact_lbl.Text = "Contact #: " + _mother_contact;
                        guardian_lbl.Text = "Guardian's: " + _guardian;
